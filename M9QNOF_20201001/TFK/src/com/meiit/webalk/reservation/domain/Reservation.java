...
public class Reservation {
	...
	public Reservation(BigDecimal amount, LocalDateTime from, boolean active, boolean processed,
			Room room, BookingPerson person) {
		super();
		this.amount = amount;
		this.from = from;
		...
		this.room = room;
		this.person = person;
		this.currency = person.getCurrency();
	}
